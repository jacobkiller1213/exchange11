  ...
  <main id="main">
    ...
    <section class="container docs-text">
      <p class="docs-p">
        ...
        которую сервис «StatPay», расположенный на доменном имени
        StatPay, может получить о Пользователе во время использования
        сайта.
      </p>
      ...
      <p class="docs-p">
        1.1.1. «Администрация сайта StatPay (далее – Администрация
        сайта) » – уполномоченные сотрудники на управления сайтом, действующие
        от имени сайта StatPay, которые организуют и (или) осуществляет
      ...
      <p class="docs-p">
        1.1.5. «Пользователь сайта StatPay (далее Пользователь)» – лицо,
      ...
      <p class="docs-p">
        2.1. Использование Пользователем сайта StatPay означает согласие
      ...
      <p class="docs-p">
        ...
        StatPay. Сервис не контролирует и не несет ответственность за
        сайты третьих лиц, на которые Пользователь может перейти по ссылкам,
        доступным на сайте StatPay.
      </p>
      <p class="docs-p">
      ...
      <p class="docs-p">
        ...
        Администрации сайта StatPay по неразглашению и обеспечению
      ...
      <p class="docs-p">
        ...
        электронной почты и создать пароль. StatPay собирает информацию от
        Пользователя, когда Пользователь входит в свою учетную запись
        StatPay. Она включает в себя электронную почту и личные данные;
        StatPay может также собирать такую информацию, как имя браузера и
      ...
      <p class="docs-p">
        4.1.7. Уведомления Пользователя сайта StatPay о состоянии
        заявки.
      </p>
      <p class="docs-p">
      ...
      <p class="docs-p">
        ...
        рассылки и иных сведений от имени StatPay.
      </p>
      <h4 class="docs-p docs-h">
      ...
      <p class="docs-p">
        ...
        между Пользователем сайта StatPay и Администрацией сайта,
      ...
      <p class="docs-p">
        ...
        размещения на сайта StatPay, если иное не предусмотрено новой
      ...
      <p class="docs-p">
        ...
        лицензирования любым членом StatPay (далее совместно именуемые
