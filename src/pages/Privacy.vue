  ...
  <main id="main">
    ...
    <section class="container docs-text">
      <p class="docs-p">
        ...
        которую сервис «Bitratex», расположенный на доменном имени
        Bitratex, может получить о Пользователе во время использования
        сайта.
      </p>
      ...
      <p class="docs-p">
        1.1.1. «Администрация сайта Bitratex (далее – Администрация
        сайта) » – уполномоченные сотрудники на управления сайтом, действующие
        от имени сайта Bitratex, которые организуют и (или) осуществляет
      ...
      <p class="docs-p">
        1.1.5. «Пользователь сайта Bitratex (далее Пользователь)» – лицо,
      ...
      <p class="docs-p">
        2.1. Использование Пользователем сайта Bitratex означает согласие
      ...
      <p class="docs-p">
        ...
        Bitratex. Сервис не контролирует и не несет ответственность за
        сайты третьих лиц, на которые Пользователь может перейти по ссылкам,
        доступным на сайте Bitratex.
      </p>
      <p class="docs-p">
      ...
      <p class="docs-p">
        ...
        Администрации сайта Bitratex по неразглашению и обеспечению
      ...
      <p class="docs-p">
        ...
        электронной почты и создать пароль. Bitratex собирает информацию от
        Пользователя, когда Пользователь входит в свою учетную запись
        Bitratex. Она включает в себя электронную почту и личные данные;
        Bitratex может также собирать такую информацию, как имя браузера и
      ...
      <p class="docs-p">
        4.1.7. Уведомления Пользователя сайта Bitratex о состоянии
        заявки.
      </p>
      <p class="docs-p">
      ...
      <p class="docs-p">
        ...
        рассылки и иных сведений от имени Bitratex.
      </p>
      <h4 class="docs-p docs-h">
      ...
      <p class="docs-p">
        ...
        между Пользователем сайта Bitratex и Администрацией сайта,
      ...
      <p class="docs-p">
        ...
        размещения на сайта Bitratex, если иное не предусмотрено новой
      ...
      <p class="docs-p">
        ...
        лицензирования любым членом Bitratex (далее совместно именуемые
