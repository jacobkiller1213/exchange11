...
<template>
    <main id="main">
          ...
          <div class="row how-it-works-list">
            ...
            <div class="how-it-works-elem">
              ...
              <div class="how-it-works-text">
                ...
                Bitratex находит лучший курс для обмена, быстро конвертирует
      ...
      >
        <div class="container">
          <div class="cashback">
            <h3 class="promo__title">Зарабатывайте с Bitratex</h3>
      ...
      <section class="faq page-block background-gray mobile-background-black">
        <div class="container">
          <h3 class="promo__title">Часто Задаваемые Вопросы о Bitratex</h3>
